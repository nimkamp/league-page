...
<footer bind:this={el}>
    ...
    {#if managersOutOfDate}
	    <p class="updateNotice">Your managers page needs an update, <a href="https://github.com/nimkamp/league-page/blob/master/TRAINING_WHEELS.md#2-add-managers">please follow the instructions</a> to get the most up-to-date experience.</p>
    {/if}
	<div id="navigation">
		<ul>
			{#each tabs as tab}
	...
	<span class="copyright">&copy; 2025 - {year} <a href="https://github.com/nimkamp/league-page">League Page</a></span>
	<br />
	<!-- PLEASE DO NOT REMOVE THE BUILT BY -->
	<span class="creator">Built by Nicholas Imkamp<br /></span>
	...
	Love League Page? Please consider saying thank you.
</footer>
